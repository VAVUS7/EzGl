...
public class TextureCubeMap extends Texture{
    ...
    public final TextureCubeMap texImage2D(Image im){
        currentBindMap().checkTexture(this);
        texImage2D(getType(), im);
        return this;
    }
    
    public final TextureCubeMap generateMipmap(){
        currentBindMap().checkTexture(this);
        generateMipmap(getType());
        return this;
    }
    
    public final TextureCubeMap setFilters(MinFilter min, MagFilter mag){
        currentBindMap().checkTexture(this);
        Texture.setFilters(getType(), min, mag);
        return this;
    }
    
    public final TextureCubeMap setWrapping(WrapMode s, WrapMode t){
        currentBindMap().checkTexture(this);
    ...
    @Override
    public TextureType getType() {return TextureType.TEXTURE_CUBE_MAP;}
